...
console.log('[GC MySQL NaN Hotfix] OK');
console.log('- mysqlRatingStore.ts ahora convierte NaN/Infinity a 0 o NULL antes de insertar.');
console.log('- Esto corrige: Unknown column \\'NaN\\' in \\'VALUES\\'.');
console.log('');
console.log('Ahora ejecuta:');
console.log('npm run build');
console.log('');
console.log('Después de desplegar, vuelve a lanzar:');
console.log("fetch('/api/gc/ratings/recalculate', { method:'POST', credentials:'include', headers:{'Content-Type':'application/json'}, body: JSON.stringify({}) }).then(r=>r.json()).then(console.log)");
